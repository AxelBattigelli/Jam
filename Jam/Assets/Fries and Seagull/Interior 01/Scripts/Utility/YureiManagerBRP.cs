    ...
    public class YureiManagerBRP : MonoBehaviour {
        ...
        private void setupPostProcessorVlume() {
            ...
            // 如果有 则检查它的完整性
                ...
                if (globalPPV.sharedProfile.GetSetting<UnityEngine.Rendering.PostProcessing.Bloom>() == null)
                    globalPPV.sharedProfile.AddSettings<UnityEngine.Rendering.PostProcessing.Bloom>();

                UnityEngine.Rendering.PostProcessing.Bloom b = globalPPV.sharedProfile.GetSetting<UnityEngine.Rendering.PostProcessing.Bloom>();
